from proove.sentences import get_preposition, get_prepositional_phrase
...
def test_verb():
    ...
    for _ in range(4):
        word = get_verb(tense = "present", quantity= 1)
    ...
    present_verbs_single = ["drink", "eat", "grow", "laugh", "think",
