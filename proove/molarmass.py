...
def main():
    ...
    # Compute moles
    molar_mass = grams / molar_mass  
    print(f"{molar_mass:.4f} moles")
    # print(moles)

def make_periodic_table():
    periodic_table_dict = {
        # ["symbol 0", "name 1", "atomicmass 2"]
        "Ac":   ["Actinium", 227],
        "Ag":   ["Silver", 107.8682],
...
def compute_molar_mass(symbol_quantity_list, periodic_table_dict):
    ...
    for inner_list in symbol_quantity_list:    
        ...
        atomicmass = periodic_table_dict[symbol][atomicmass_INDEX]
